<!-- BEGIN: main -->
	...
	<!-- END: loop -->
	<form name="add_cbdoan" action="{ACTION}" method="POST" enctype="multipart/form-data" onsubmit="return validate(this)">
		<table class="tab1">
		<tbody>
			<tr>
			...
			<tr>
				...
				<td>
                    <select name="macvu1">
                        ...
                        <!-- BEGIN: cv1 -->
							<option value="{LIST_CV.macvu}">{LIST_CV.tenchucvu}</option>
                        <!-- END: cv1 -->
                    </select>
